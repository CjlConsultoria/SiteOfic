...
const systems = [
  {
    name: 'Convivium',
    icon: '🏢',
    tagline: 'Sistema de gestão para condomínios e prédios residenciais',
    badge: 'Operacional',
    ...
    platform: 'Web (SaaS)',
    description: 'Plataforma completa de gestão condominial. Controle de moradores, encomendas, reclamações, comunicados, financeiro e muito mais — tudo em um único painel para síndicos e administradoras.',
    features: [
      'Gestão de moradores com cadastro por bloco, apartamento e vagas',
      'Controle de encomendas com QR code, fotos e código de retirada',
      'Sistema de reclamações e denúncias com prioridade e acompanhamento',
      'Comunicados do condomínio com confirmação de leitura',
      'Dashboard financeiro com cobrança integrada (Stripe)',
      'Controle de visitantes e solicitações de manutenção',
      'Notificações por WhatsApp e email',
      'Multi-condomínio: gerencie vários prédios em uma conta',
    ],
    audience: 'Síndicos, administradoras de condomínios, portarias e moradores de prédios residenciais e comerciais.',
