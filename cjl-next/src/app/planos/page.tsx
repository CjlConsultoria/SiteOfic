          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {plans.map((plan, i) => (
              ...
              >
                ...
                <div className="mb-4">
                  <span className="text-3xl font-extrabold text-[#d4a017]">
                    {plan.price}
                  </span>
                ...
                <a
                  ...
                  className="block text-center text-sm font-bold py-3 px-4 rounded-xl bg-[#d4a017] text-white hover:bg-[#e85d2c] transition-colors duration-200 shadow-sm"
                >
                  Contratar
                </a>
              </div>
