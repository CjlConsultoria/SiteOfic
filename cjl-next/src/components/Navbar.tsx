      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link href="/registre" className="text-sm font-semibold px-5 py-2 rounded-full border border-[#d4a017] text-[#d4a017] hover:bg-[#d4a017] hover:text-black transition-all">
              Cadastre-se
            </Link>
          </div>
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${menuOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}>
        <div className="border-t border-gray-800 bg-black px-4 py-4 space-y-1">
          ...
          <div className="border-t border-gray-800 pt-3 mt-3 flex flex-col gap-2">
            <Link href="/login" className="block text-sm font-medium py-3 px-3 rounded-lg text-gray-300 hover:text-white hover:bg-gray-900 transition-colors">
              Login
            </Link>
            <Link href="/registre" className="block text-sm font-semibold py-3 px-3 rounded-lg text-center border border-[#d4a017] text-[#d4a017] hover:bg-[#d4a017] hover:text-black transition-all">
              Cadastre-se
            </Link>
          </div>
        </div>
